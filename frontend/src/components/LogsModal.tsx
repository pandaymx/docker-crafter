...
import { X, ArrowDownToLine, Loader2, Wifi, WifiOff } from "lucide-react";
...
export function LogsModal({ containerId, containerName, onClose }: LogsModalProps) {
  ...
  const processLogData = useCallback((type: "stdout" | "stderr", data: string) => {
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800 bg-zinc-900/50">
            ...
            <div className="flex items-center gap-1.5 text-xs">
              ...
              <span className={cn(
                ...
                {wsStatus === "connected" ? "Connected" :
                 wsStatus === "connecting" ? t("logsModal.refreshing") :
                 wsStatus === "error" ? t("logsModal.fetchError") :
                 "Disconnected"}
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="hidden sm:inline">{t("logsModal.autoScroll")}</span>
            </Button>
            <Button
              variant="secondary"
              size="sm"
