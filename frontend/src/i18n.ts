...
const resources = {
  en: {
    translation: {
      ...
      subtitle: "Smart Workspace Mode: Automatically aggregated local Compose projects & standalone containers • Last sync: {{lastUpdated}}",
      syncing: "Syncing...",
      stats: {
      ...
      logsModal: {
        ...
        truncatedWarning: "[Notice] Early logs truncated. Buffer limit: {{limit}} lines.",
      },
      terminalModal: {
        title: "Terminal - {{name}}",
        close: "Close",
  ...
  zh: {
    translation: {
      ...
      subtitle: "智能工作区模式：已自动聚合本地 Compose 项目与独立容器 • 最后同步：{{lastUpdated}}",
      syncing: "同步中...",
      stats: {
        workspaces: "应用工作区",
        containers: "容器总数",
